...
def draw_main_text():
    ...
    text("The quick brown fox jumps over the lazy dog.", (left, top))

    text("El veloz murciélago hindú comía feliz cardillo y kiwi. La cigüeña", (left, top - 1.5 * font_size))
    text("tocaba el saxofón detrás del palenque de paja.", (left, top - 2.5 * font_size))

    text("Le cœur déçu mais l'âme plutôt naïve, Louÿs rêva de crapaüter en", (left, top - 4 * font_size))
    text("canoë au delà des îles, près du mälströn où brûlent les novæ.", (left, top - 5 * font_size))

    text("Kæmi ný öxi hér ykist þjófum nú bæði víl og ádrepa.", (left, top - 6.5 * font_size))
